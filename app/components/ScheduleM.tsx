...
const ScheduleM = () => {
  ...
  return (
    <section id='scheduleM' className='flex min-h-[600px] pt-[8rem] pr-[0.5rem] pb-[2rem] relative justify-center flex-wrap box-border lg:hidden md:hidden'>
        {/* TITLE */}
        <div className='absolute top-0 left-0 z-0 box-border block intersect-once intersect:motion-preset-slide-right motion-duration-1000'>
            <h2 className='text-moss -rotate-90 relative m-0 whitespace-nowrap text-ellipsis z-0 pb-[0.5rem] top-[15rem] left-[-1.8rem] text-[3.2rem] leading-[0.9]'>Timeline</h2>
        </div>
        {/* CONTENT */}
                    ...
                    <div className='mr-0 ml-0 flex flex-wrap box-border'>
                        <div className='grow-0 shrink-0 basis-[100%] max-w-[100%] relative w-[100%] min-h-[1px] pl-[15px] pr-[15px] box-border block'>
                            ...
                            <p className='text-moss text-[1.2rem]'>Tuesday, November 18 <br /> 4:00 pm</p>
                                <a href='#top2' onClick={toggleNav} onClickCapture={() => {handleNavigation('ss'); handleItem('s2')}} className='text-moss text-[1.9rem] leading-[1.3] box-border hover:underline'>
                                    Ceremony <a className='font-greatVibesR'>&</a> Reception
                                    <p className='text-moss text-[1.125rem] leading-[1.9] break-normal overflow-hidden relative z-2 mt-0 mb-[2.5rem] block font-medium'>+ View Details</p>
                                </a>
                            </div>
        ...
        <div className={`${toggleMenu? '': 'hidden'} z-4 md:hidden size-full fixed top-0 right-0 m-0 bg-white overflow-x-hidden`}>
            ...
            <div id='top2' className='relative flex flex-col bg-clip-padding box-border'>
                ...
                <div className='relative z-1 h-[4.3rem] flex items-center justify-between p-[15px box-border] intersect-once intersect:motion-preset-slide-right motion-duration-1000'>
                    <h1 className='text-moss text-[2.2rem] pt-[50px] ml-[15px] font-medium'>&nbsp;Timeline</h1>
                </div>
                {/* FLOWER 1 */}
                <div className='w-[6rem] h-[10rem] top-[0.2rem] left-[18rem] rotate-x-180 rotate-115 absolute z-1 pointer-events-none box-border block intersect-once intersect:motion-preset-slide-left motion-duration-1000'>
                    <Image 
                        alt=''
        ...
        {/* FLOWER 1 */}
        <div className='w-[9rem] h-[13rem] top-[0%] rotate-x-180 rotate-105 left-[65%] absolute z-1 pointer-events-none box-border block intersect-once intersect:motion-preset-slide-up motion-duration-1000'>
            <Image 
                alt=''
                src={'/flowers/floater_4.png'}
                fill
