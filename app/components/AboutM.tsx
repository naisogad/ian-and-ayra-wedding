            ...
            <div className='justify-end flex flex-wrap box-border'>
                <div className='ml-auto grow-0 shrink-0 basis-[100%] max-w-[100%] pl-[15px] pr-[15px] box-border block bg-amber-50'>
                    <div className='text-[1.125rem] leading-[1.5] text-moss box-border block'>
                        ...
                        <p className='mt-[0.5rem] break-words relative z-2 text-left mb-[1rem] block intersect-once intersect:motion-preset-slide-left motion-duration-1400'>We’re so excited to be getting married and to share this special journey with our favorite people—you! Your presence is a gift from God that we deeply treasure.<br /> </p>
