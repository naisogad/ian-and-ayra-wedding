              ...
              <div className='justify-end flex flex-wrap box-border'>
                ...
                <div className='grow-0 shrink-0 basis-[100%] max-w-[100%] relative w-[100%] min-h-[1px] pl-[15px] pr-[15px] bg-amber-50 box-border block'>
                  ...
                  <div className='flex box-border pb-[2rem] overflow-x-auto snap-x snap-mandatory snap-center'>
                     ...
                     <div className='intersect-once intersect:motion-preset-slide-left motion-duration-2100'><ImageFlip frontImageSrc={'/pictures/transition/couple-9.jpg'} backContent={<p className="text-moss p-4"><a className='font-bold'> July 02, 2024 –</a><br /><br />Hard launch agad!<br />Sabi nga a testimony should be told, there is no lamp under the bed.<br />Hindi pwedeng itago o isecret ang testimony.<br />Sabi ni Lord, let them see His light sa relationshop natin.<br />At doon nagumpisa magliwanag ang ikaw at ako</p>} height={500} width={300}/></div>
                     ...
                     <div className='intersect-once intersect:motion-preset-slide-left motion-duration-2100'><ImageFlip frontImageSrc={'/pictures/transition/couple-30.jpg'} backContent={<p className="text-moss p-4"><a className='font-bold'> January 03, 2025 –</a><br /><br />First date of the year!<br />Group date na naman,<br />pero parang prenup ang itsura natin.</p>} height={500} width={300}/></div>
