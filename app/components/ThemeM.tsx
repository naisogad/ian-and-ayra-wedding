...
const ThemeM = () => {
  return (
    <section className='min-h-[1px] pt-[6em] pb-[6em] relative justify-center flex flex-wrap box-border lg:hidden'>
        ...
        <div className='absolute z-0 box-border block'>
            <h2 className='text-moss -rotate-90 relative whitespace-nowrap text-ellipsis z-0 pb-[0.5rem] top-[4.8em] left-[-2.8em] md:left-[-4.2em] text-[3.2em] md:text-[4em] leading-[0.9]'>Wedding Attire</h2>
        </div>
        {/* CONTENT */}
                    ...
                    <div className='flex flex-wrap box-border'>
                        <div className='grow-0 shrink-0 basis-[100%] max-w-[100%] relative w-[100%] min-h-[1px] pl-[1em] pr-[1em] box-border block'>
                            ...
                            <div className='box-border block pl-[1em] pr-[1em] pt-[1.8em] md:pt-[1em]'>
                                <h3 className='text-moss text-[2em] leading-[1] pb-[0.8em] text-center'>Dress Code</h3>
                            </div>
                            {/* IMAGE */}
                            ...
                            <div className='box-border block text-left pt-[1em] pl-[1em] pr-[1em] mb-[1em]'>
                                <p className='text-moss text-[1.125em]'>We kindly ask our guests to dress in semi-formal or smart casual attire for our special day.</p>
                            </div>
                            <div className='box-border block text-left pl-[1em] pr-[1em] mb-[1em]'>
                                <p className='text-moss text-[1.125em]'><a className='font-semibold inline-block'>For the Ladies:</a> Feel effortlessly elegant in a flowy dress or chic jumpsuit—perfect for day-to-night celebration vibes. Pair with comfy heels or flats and your prettiest smile. ✨</p>
                            </div>
                            <div className='box-border block text-left pl-[1em] pr-[1em] mb-[4rem]'>
                                <p className='text-moss text-[1.125em]'><a className='font-semibold inline-block'>For the Gentlemen:</a> Aim for a clean and classic look — something comfortable, coordinated, and event-appropriate. Whether it’s a dress shirt, polo, or simple blazer and khaki or slacks, just come looking your best. 👔</p>
                            </div>
                            {/* TITLE */}
                            ...
                            <div className='box-border block text-left pl-[1em] pr-[1em] mt-[3em]'>
                                <p className='text-moss text-[1.125em]'>Our wedding will feature these elegant colors. We kindly ask that you skip the color black. Have fun mixing and matching the colors from our palette for your look! <br /> <br /> Lastly guests, wear your best accessories. Your smiles and lively personalities.</p>
                            </div>
                            {/* COLORS */}
                            <div className='flex flex-wrap justify-evenly gap-[2em] text-center mt-[3em] mb-[3em]'>
                                ...
                                <div className='flex flex-col items-center box-border'>
                                    ...
                                    <p className='text-moss text-[1.125em] mt-[1em]'>Guests</p>
                                </div>
                            </div>
                        </div>
                    </div>
